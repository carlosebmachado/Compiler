...
import br.univali.ttoproject.ide.components.Debug;
...
public class App extends JFrame {
	...
	public void fRun() {
		if (!compiled) {
			JOptionPane.showMessageDialog(null, "Please, compile your file before running.", "Warning", JOptionPane.OK_OPTION);
			return;
		}
		running = true;
	}
...
//		JOptionPane.showMessageDialog(null, label, "Help", JOptionPane.QUESTION_MESSAGE);
	...
	public boolean verifySaveFile() {
		int result = JOptionPane.showConfirmDialog(null, "Would you like to save the file?", "Save", JOptionPane.YES_NO_CANCEL_OPTION);
			...
			if (userSelection == JFileChooser.APPROVE_OPTION) {
			    ...
			    if (save) {
			    	if (fileToSave.exists()) {
						int result = JOptionPane.showConfirmDialog(null, "A file with that name already exists. Would you like to overwrite?", "Overwrite", JOptionPane.YES_NO_OPTION);
						if (result == JOptionPane.YES_OPTION) {
							existisVerDone = true;
						}
						if (result == JOptionPane.NO_OPTION) {
